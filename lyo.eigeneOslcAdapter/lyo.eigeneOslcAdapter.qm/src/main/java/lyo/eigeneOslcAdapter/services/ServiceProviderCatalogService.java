...
import lyo.eigeneOslcAdapter.ServerConstants;
...
public class ServiceProviderCatalogService
{
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/lyo/eigeneoslcadapter/serviceprovidercatalog.jsp");
            try {
