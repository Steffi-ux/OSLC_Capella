...
package lyo.eigeneOslcAdapter.services;
...
import lyo.eigeneOslcAdapter.RestDelegate;
...
{	
	private CapellaConnector capellaConnector = new CapellaConnector();
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId) throws ServletException, IOException
    {
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/lyo/eigeneoslcadapter/serviceprovider.jsp");
