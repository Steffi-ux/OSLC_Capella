...
<body>
  ...
  <div class="container">
    ...
    %>
    <p><a href="<%=request.getContextPath()%>/lyo/eigeneoslcadapter/selectiondialogsampleclient.jsp?selectionUri=<%= URLEncoder.encode(selectionDialog.toString(), "UTF-8") %>">Sample Selector Dialog Client</a> For {<%= listResourceTypes(selectionDialogs[selectionDialogIndex].getResourceTypes()) %>}</p>
    <%}%>
    <%
    ...
    %>
    <p><a href="<%=request.getContextPath()%>/lyo/eigeneoslcadapter/creationdialogsampleclient.jsp?creationUri=<%= URLEncoder.encode(creationDialog.toString(), "UTF-8") %>">Sample Creation Dialog Client</a> For {<%= listResourceTypes(creationDialogs[creationDialogIndex].getResourceTypes()) %>}</p>
    <%}%>
    </div>
