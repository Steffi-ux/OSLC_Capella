...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - OSLC Server QM DocDir OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>OSLC Server QM DocDir Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>lyo.eigeneOslcAdapter.RestDelegate</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
